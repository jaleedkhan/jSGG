...
def make_data_loader(cfg, img, mode='train', is_distributed=False, start_iter=0):
    ...
    lol = os.path.join(str(str(cfg.PATHS_CATALOG)[0:-3] + "_2.py"))
    ...
    return data_loaders, custom_data_info
