...
def im2scenegraph(tst_img, MPDC):
    ...
    TCP = 'C:/Users/danya/checkpoints/custom_images'

    # The path for output of SGG for custom images, if TEST.CUSTUM_EVAL is 'True'
    DSD = 'C:/Users/danya/checkpoints/your_output_path'
...
def main():
    image = Image.open('tools/bike.jpg').convert("RGB")
    pretrained_model_path = 'D:\\Downloads\\upload_causal_motif_sgdet'
